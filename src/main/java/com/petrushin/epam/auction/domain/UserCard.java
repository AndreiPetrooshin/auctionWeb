...
public class UserCard implements Identified {
    ...
    public static final String GET_BY_ID =
            "SELECT c.card_id, c.card_name, c.card_number, u.user_id, u.u_login, " +
                    ...
                    "c.user_id=u.user_id AND u.role_id=r.role_id AND c.card_id=?";
    ...
    public static final String GET_BY_USER_ID ="SELECT c.card_id, c.card_name, c.card_number, u.user_id, u.u_login, " +
            "u.u_email, u.u_password, u.role_id, r.user_role " +
            "FROM user_cards c JOIN user u, user_role r WHERE " +
            "c.user_id=u.user_id AND u.role_id=r.role_id AND c.user_id=?";
