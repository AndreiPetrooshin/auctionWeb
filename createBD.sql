...
CREATE TABLE IF NOT EXISTS `flowers_auction_bd`.`user_role` (
  `role_id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Идентификатор роли пользователя',
...
CREATE TABLE IF NOT EXISTS `flowers_auction_bd`.`user` (
  `user_id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Идентификатор юзера',
  `role_id` INT UNSIGNED NOT NULL COMMENT 'Идентификатор прав юзера',
...
CREATE TABLE IF NOT EXISTS `flowers_auction_bd`.`user_cards` (
  `card_id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Идентификатор способа оплаты юзера',
  `user_id` INT UNSIGNED NOT NULL COMMENT 'Идентификатор юзера',
...
CREATE TABLE IF NOT EXISTS `flowers_auction_bd`.`user_shipping_address` (
  `ship_addr_id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Идентификатор пользователя',
...
CREATE TABLE IF NOT EXISTS `flowers_auction_bd`.`flower_lot` (
  `fl_id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Идентификатор лота цветка',
  `user_id` INT UNSIGNED NOT NULL COMMENT 'Пользователь, владелец лота',
...
CREATE TABLE IF NOT EXISTS `flowers_auction_bd`.`bets_m2m` (
  ...
  `fl_id` INT UNSIGNED NOT NULL COMMENT 'Идентификатор лота\n',
  `user_id` INT UNSIGNED NOT NULL COMMENT 'Идентификатор юзера',
  `user_bet` DECIMAL(10,2) UNSIGNED NOT NULL COMMENT 'Ставки которые делают юзеры',
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `flowers_auction_bd`.`payments` (
